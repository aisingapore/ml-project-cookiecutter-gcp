...
COPY aisg-context/jupyter/fix-permissions /usr/local/bin/fix-permissions
...
COPY aisg-context/jupyter/start.sh aisg-context/jupyter/start-notebook.sh aisg-context/jupyter/start-singleuser.sh /usr/local/bin/
# Currently need to have both jupyter_notebook_config and jupyter_server_config to support classic and lab
COPY aisg-context/jupyter/jupyter_notebook_config.py /etc/jupyter/
